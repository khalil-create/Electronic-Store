                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            @foreach (Auth::user()->unreadnotifications as $notify)
                                ...
                                @endphp
                                <a href="{{ route($route, ['id' => $notify->id]) }}" title="التفاصيل"
                                    class="btn btn-block btn-default btn-lg col-md-12">
                                    <div class="col-12" style="margin-bottom: 2px">
                                        <div class="col-md-12">
                                            <h6 style="float:right;margin-bottom: 2px">{{ $notify->data['content'] }}</h6>
                                            <br>
                                            <p class="text-sm text-bold text-muted"
                                                style="float: right;margin:-5px -8px 0px 0px"><i class="far fa-clock mr-2"

...
<?php $__env->startSection('sys-variables'); ?>
    <form id="myform" name="myform" method="POST" action="<?php echo e(url($urls['update-form'])); ?>"
        ...
        <div class="card-body">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="currency_id" class="form-control custom-select rounded-0" id="currency_id">
                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cur->id); ?>" <?php echo e(old('currency_id', $data->currency_id) == $cur->id ? 'selected' : ''); ?>>
            ...
            <div class="form-group col-md-4">
                <label for="price_room">السعر الافتراضي للغرفة<span class="text-danger">*</span></label>
                <input type="number" name="price_room" id="price_room" value="<?php echo e(old('price_room', $data->price_room)); ?>"
                    class="form-control">
                <?php if($errors->has('price_room')): ?>
                    <span class="help-block">
                        <small class="form-text text-danger"><?php echo e($errors->first('price_room')); ?></small>
                    </span>
                <?php endif; ?>
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                <label for="font_size">حجم الخط<span class="text-danger ">*</span></label>
                <select name="font_size" class="form-control custom-select rounded-0" id="font_size">
                    <?php $__currentLoopData = App\Arrays\Lists::FONTSIZES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"
                            <?php echo e(old('font_size', $data->font_size) == $key ? 'selected' : ''); ?>>
                            <?php echo e($value); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('font_size')): ?>
                    <span class="help-block">
                        <small class="form-text text-danger"><?php echo e($errors->first('font_size')); ?></small>
                    </span>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Open Source Systems\Hotal Managment System\project\resources\views/admin/system-variables/index.blade.php ENDPATH**/ ?>
        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4 product simpleCart_shelfItem text-center">
                <a href="<?php echo e(route('show.item', $row->id)); ?>">
                    ...
                    <img src="<?php echo e(asset('images/items/'.$row->images->first()->image)); ?>" class="image" alt="" />
                </a>
                <div class="mask">
...
<?php endif; ?>
<?php /**PATH E:\Laravel\E-Shop\Electronic Store\resources\views/items/ajax_search.blade.php ENDPATH**/ ?>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <?php if(isset($head_data['head3'])): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <li class="breadcrumb-item active"><?php echo e(__('Show')); ?></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="col-sm-12">
                                <div>
                                    ...
                                    <?php if(!isset($exist['btn_add'])): ?>
                                        <a href="<?php echo e(url('#')); ?>" class="btn btn-primary add"
                                            onclick="openForm()">
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Open Source Systems\Blogs Projects\project\resources\views/layouts/base.blade.php ENDPATH**/ ?>
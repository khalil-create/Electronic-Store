...
<nav class="main-header navbar navbar-expand navbar-default navbar-light bg-gradient-yellow">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="/<?php echo e(request()->path()); ?>" class="nav-link"><i class="fas fa-refresh"
                    title="<?php echo e(__('Refresh')); ?>"></i></a>
        </li>
    </ul>
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <?php if($user->image): ?>
                    <img src="<?php echo e(asset('images/users/' . $user->image)); ?>" class="user-image img-circle elevation-2"
                        alt="User Image">
                <?php else: ?>
                    <img src="<?php echo e(asset('designImages/user.png')); ?>" class="user-image img-circle elevation-2"
                        alt="User Image">
                <?php endif; ?>
                <span class="d-none d-md-inline mr-2"><?php echo e($user_name[0]); ?> </span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    ...
                    <p>
                        ...
                        <?php echo e($user->type == 1 ? 'أدمن' : 'مستخدم'); ?>
                ...
                <li class="user-footer">
                    <a href="<?php echo e(route('profile.index', $user->id)); ?>"
                        class="btn btn-default btn-flat float-left"><?php echo e('البروفايل'); ?></a>
                    <a href="<?php echo e(route('logout')); ?>"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                        class="btn btn-default btn-flat float-right">
                        <?php echo e('تسجيل الخروج'); ?> <i class="fas fa-sign-out-alt"></i></a>
...
<?php /**PATH E:\Laravel\E-Shop\Electronic Store\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>
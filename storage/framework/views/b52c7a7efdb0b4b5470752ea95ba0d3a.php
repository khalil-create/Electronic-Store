<div class="formPopup card card-default" id="popupForm">
    <div class="card-header">
        <h3 id="card-title-pop-form" class="card-title" style="float: right"><?php echo e($head_data['card-title-pop-form']); ?>

            <?php echo $__env->yieldContent('card-title'); ?></h3>
...
</div><!-- /.formPopup --><?php /**PATH F:\Open Source Systems\Hotal Managment System\project\resources\views/layouts/pop-form.blade.php ENDPATH**/ ?>